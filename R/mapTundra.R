mapTundra <- function(x, title, type = NULL, datasource, palette = "Spectral", reverse = TRUE, bins = 7){
  ...
  compassRose(x = xrose, y = yrose, cex.cr = .475, cex.let = .5,
    col = c("white", dark1), border = dark1, labels = "", rot = -67.5
  )
  compassRose(x = xrose, y = yrose, cex.cr = .475, cex.let = .5,
    col = c("white", dark1), border = dark1, labels = "", rot = -22.5
  )
  compassRose(x = xrose, y = yrose, cex.cr = .65, cex.let = .5,
    col = c("white", dark1), border = dark1, labels = "", rot = -45
  )

  compassRose(x = xrose, y = yrose, cex.cr = .75, cex.let = .5,
    col = c("white", dark1), border = dark1, offset = 1.15, col.let = dark1
  )
}
